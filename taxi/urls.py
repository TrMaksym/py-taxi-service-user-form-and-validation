...
from .views import (
    ...
    ManufacturerDeleteView, DriverUpdateView, remove_driver_from_car, assign_driver_to_car,
)
...
urlpatterns = [
    ...
    path("drivers/<int:pk>/update-license/", DriverUpdateView.as_view(), name="driver-update"),
    path("drivers/<int:pk>/delete/", DriverDeleteView.as_view(), name="driver-delete"),
    path('cars/<int:pk>/assign-driver/', assign_driver_to_car, name='assign-driver-to-car'),
    path('cars/<int:pk>/remove-driver/', remove_driver_from_car, name='remove-driver-from-car'),
]
